...
public class AnimatorBiAtAc1 extends JApplet 
...
//	  Ellipse2D elipse = new Ellipse2D.Double(100, 100, 50, 100);
   ...
   public void paint( Graphics g )
   {
      ...
      alfaCompo = alfaCompo - 0.1f;
	  if (alfaCompo <= 0.05) alfaCompo = 1.0f;
	  ac =  AlphaComposite.getInstance(AlphaComposite.SRC_OVER,alfaCompo);
   ...
   {
      AnimatorBiAtAc1 anim = new AnimatorBiAtAc1();
